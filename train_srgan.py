...
from module.srgan import SRGAN
from module.vgg import VGG
from module.srgan_training import SRGANTraining
from module import config
from module.losses import Losses
...
ap.add_argument("--device", required=True, default="gpu", choices=["gpu", "tpu"], type="str", help="device to use for training (gpu or tpu")
